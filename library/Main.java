...
public class Main {
    public static void main(String[] args) {
        ...
        while (in) {
            ...
            switch (command){
                case "add":
                    library.add(strArr[1]);
                    break;
                case "delete":
                    library.delete(strArr[1]);
                    break;
                case "set":
                    library.set(strArr[1],strArr[2],strArr[3]);
                    break;
                case "get":
                    System.out.println(library.get(strArr[1],strArr[2]));
                    break;
                case "rent": 
                    library.rent(strArr[1]);
                    break;
                case "return":
                    library.returns(strArr[1]);
                    break;
                case "search": 
                    library.search(strArr[1],strArr[2]+" "+strArr[3]);
                    break;
                case "print":
